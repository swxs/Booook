...
```
cloc --by-lang --exclude-dir apps,tests --3 ./
```

```
github.com/AlDanial/cloc v 1.70  T=11.74 s (199.1 files/s, 90326.8 lines/s)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
File                                                                                                              blank   comment      code    scale   3rd gen. equiv
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
./xxx.py                                                                                                          1808       584     36344 x   4.20 =      152644.80
./xxx                                                                                                                1         0         0 x   4.20 =           0.00
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
SUM:                                                                                                             103302    112557    844995 x   4.12 =     3477467.83
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
```
